...
namespace Noorisys\StripeSubscription\Controllers\api;

use App\Http\Controllers\Controller;

use Noorisys\StripeSubscription\Models\Bookings;
use Noorisys\StripeSubscription\Models\Charges;
use Noorisys\StripeSubscription\Models\Plan;
use Noorisys\StripeSubscription\Models\Subscriptions;
use Noorisys\StripeSubscription\Models\User;
use function Noorisys\StripeSubscription\Helpers\generateInvoicePdf;
...
class StripeController extends Controller
{
    ...
    public function __construct() {
        ...
        $this->stripe_key = Stripe::setApiKey(Config::get('stripe.STRIPE_SECRET'));
    }
        ...
        try{
            ...
            if (!empty($payment_details)) {
                ...
                if($session->payment_status == "paid" && $session->status == "complete"){
                    ...
                    // update users active_subscription_id
                    $plan = Plan::where('plan_id','=',$item->plan->id)->first();
                    $user_data = [
                        'active_subscription_id' => $plan ? $plan->id : '',
        ...
        switch ($event->type) {
            case 'charge.failed':
                ...
                if($status == 'failed')
                {
                    ...
                    User::where('stripe_id','=',$customer_id)->update($user_data);
